...
OI.ready(function(){
	...
	function FigureMenu(el){
		...
		if(oiviz){
			...
			el.appendChild(item);
			// If this is within a tabpanel we will take the whole panel
			if(oiviz.parentNode.getAttribute('role')=="tabpanel") tabpanel = oiviz.parentNode;
			btn.addEventListener("click", function (e) {
				saveDOMImage(tabpanel||oiviz, { "file": "figure.png" });
			});

			// Save a copy of the SVG if it exists
			svg = oiviz.querySelector(".oi-map-inner");
